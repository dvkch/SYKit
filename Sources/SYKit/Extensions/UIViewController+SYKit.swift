...
public extension UIViewController {
    ...
    func present(_ viewControllerToPresent: UIViewController, afterDismissing other: UIViewController, animated: Bool, completion: (() -> Void)? = nil) {
        other.dismiss(animated: animated) {
